  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center">
        ...
        />
        <p className="p-4">
          Example of a man whitnessing the miracle of the tinling for the first
          time in his life. Notice the immense joy radiating from him.
        </p>
      </div>
      <div className="flex items-center justify-center pb-8">
        <p className="p-4">
          If you join us in this journey, you will be witnessing the miracle of
          the tinling for the first time in your life. You will be able to see
          the power of the tinling and the impact it can have on your life. And
          you will be spared when the wrath of the tinling comes.
        </p>
        <Image
          className="w-1/3 "
